function [sys,x0,str,ts]= reactor2_sfcn(t,x,u,  flag,    Wm1, Wm2, Wm3, Wm4, Wm5, Wm6, Wm7, Wm8, Wm9, Wm10,    Wme1, Wme2, Wme3, Wme4, Wme5, Wme6, Wme7, Wme8, Wme9, Wme10,     Ww1, Ww2, Ww3, Ww4, Ww5, Ww6, Ww7, Ww8, Ww9, Ww10,    Wc1, Wc2, Wc3, Wc4, Wc5, Wc6, Wc7, Wc8, Wc9, Wc10,    Wh1, Wh2, Wh3, Wh4, Wh5, Wh6, Wh7, Wh8, Wh9, Wh10,    T1, T2, T3, T4, T5, T6, T7, T8, T9, T10)
...
switch flag
 ...
 case 1 % derivatives
 [dx,Pout] = SimulinkReactor2(t,x,u) ;
 sys = dx;
...
%   sys = [  Wm(end) ; Wme(end) ; Ww(end) ; Wc(end) ; Wh(end) ;  T(end) ]; %
