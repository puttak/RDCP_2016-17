function [dx]=SimulinkHeatExchanger2 (t,x,u)
global A L Circ U0 Cpw rhow AO n2  % Tin 

Fiwatertotal=u(1)/18;
Fiwater=u(1)/50; %Cooling Water Flowrate (kmol/hr)
Wm=u(2);
Wme=u(3);
Ww=u(4);
Wc=u(5);
...
Pin=u(7);
Tin = u(8);
FiMass=u(9)/50; % Total mass flowrate (kg/hr)
...
L=3.65/n2; %Length of heat exchanger pipe divided by number of discrete sections it is split up into
